...
workDir <- "/Users/cnm006/Documents/RNASeqProject/SARTools.DESeq2.genes.batch"      # working directory for the R session

projectName <- "SARTools.DESeq2.genes.batch"                         # name of the project
...
featuresToRemove <- "batch"        # names of the features to be removed
